...
const EXPERIENCE_AR = {
  ...
  "Artificial Intelligence Club": {
    ...
    role: "قائدة مشاركة – إدارة المشاريع",
  ...
  "Drone Club": {
    ...
    role: "قائدة إدارة المشاريع",
    date: "سبتمبر 2025 – حتى الآن",
    desc: "قادت التخطيط على مستوى اللجنة ودعمت أنشطة النادي من خلال التنسيق وإدارة المهام والتواصل مع الفريق.",
  ...
  "Saudi Automobile & Motorcycle Federation": {
    ...
    desc: "أعمل كمسؤولة فحص فني منذ مارس 2024 في عدة فعاليات لرياضة السيارات، وأنا عضو في فريق الفحص الفني لبطولة فورمولا إي المصنّف ضمن أفضل 3 فرق عالميًا، إلى جانب دعم أعمال الفحص والامتثال الفني.",
